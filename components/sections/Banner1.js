                    ...
                    <div className="row">
                            ...
                            <div className="banner__content">
                                ...
                                <div className="banner__btn-wrap" data-aos="fade-right" data-aos-delay={800}>
                                    <div className="tg-button-wrap">
                                        <Link href="/online" className="btn tg-svg"><span className="text">Online Courses</span>
                                            <span className="svg-icon" id="svg-1" data-svg-icon="assets/img/icons/btn-arrow.svg" /></Link>
                                    </div>
                                    <div className="tg-button-wrap">
                                        <Link href="/offline" className="btn tg-svg"><span className="text">Offline Courses</span>
                                            <span className="svg-icon" id="svg-1" data-svg-icon="assets/img/icons/btn-arrow.svg" /></Link>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-6">
                            <div className="banner__images">
                                <img src="/shivamsir.png" alt="img" className="main-img" />
