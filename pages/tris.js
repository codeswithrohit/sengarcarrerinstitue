          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white z-10">
              ...
              <p className="text-xl md:text-2xl text-blue-200 mb-8">
                TriS Education - School Curriculum + Competitive Coaching in One Package
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  ...
                  <span className="text-blue-100">School syllabus + competitive exam preparation</span>
                </li>
                <li className="flex items-center">
                  <svg className="w-6 h-6 mr-2 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            ...
            <div className="bg-white rounded-xl shadow-2xl overflow-hidden transform transition-all hover:shadow-3xl border border-blue-200/30">
              <div className="bg-gradient-to-r from-blue-900 to-blue-800 p-6 md:p-8">
                <h2 className="text-2xl md:text-3xl font-bold text-white">TriS Admission Form</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
              ...
              <p className="text-gray-600 italic">
                "TriS's combined approach meant I didn't have to juggle between different coaching centers. Everything was under one roof with coordinated study plans."
              </p>
            </div>
